                    ...
                    <div class="tab-content p-4" id="newsTabContent">
                        ...
                        <div class="tab-pane fade show active" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg @error('title_ar') is-invalid @enderror" id="title_ar" name="title_ar" value="{{ old('title_ar', $news->title_ar) }}" placeholder="أدخل العنوان بالعربية..." required style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control summernote @error('content_ar') is-invalid @enderror" id="content_ar" name="content_ar" rows="6" required>{{ old('content_ar', $news->content_ar) }}</textarea>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('tags_ar') is-invalid @enderror" id="tags_ar" name="tags_ar" value="{{ old('tags_ar', $news->tags_ar) }}" placeholder="سيارات, عروض, تحديث..." style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('meta_title_ar') is-invalid @enderror" id="meta_title_ar" name="meta_title_ar" value="{{ old('meta_title_ar', $news->meta_title_ar) }}" style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control @error('meta_description_ar') is-invalid @enderror" id="meta_description_ar" name="meta_description_ar" rows="3" style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">{{ old('meta_description_ar', $news->meta_description_ar) }}</textarea>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control @error('meta_keywords_ar') is-invalid @enderror" id="meta_keywords_ar" name="meta_keywords_ar" value="{{ old('meta_keywords_ar', $news->meta_keywords_ar) }}" placeholder="أخبار, سيارات, تحديث..." style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
                        ...
                        <div class="tab-pane fade" id="english" role="tabpanel" aria-labelledby="english-tab">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg @error('title_en') is-invalid @enderror" id="title_en" name="title_en" value="{{ old('title_en', $news->title_en) }}" placeholder="Enter title in English..." required style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
                                @error('title_en') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="form-group mb-4">
                                <label for="content_en" class="form-label fw-bold">{{ __('Content') }} (EN) <span class="text-danger">*</span></label>
                                <textarea class="form-control summernote @error('content_en') is-invalid @enderror" id="content_en" name="content_en" rows="6" required>{{ old('content_en', $news->content_en) }}</textarea>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('tags_en') is-invalid @enderror" id="tags_en" name="tags_en" value="{{ old('tags_en', $news->tags_en) }}" placeholder="cars, offers, update..." style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control @error('meta_title_en') is-invalid @enderror" id="meta_title_en" name="meta_title_en" value="{{ old('meta_title_en', $news->meta_title_en) }}" style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control @error('meta_description_en') is-invalid @enderror" id="meta_description_en" name="meta_description_en" rows="3" style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">{{ old('meta_description_en', $news->meta_description_en) }}</textarea>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control @error('meta_keywords_en') is-invalid @enderror" id="meta_keywords_en" name="meta_keywords_en" value="{{ old('meta_keywords_en', $news->meta_keywords_en) }}" placeholder="news, cars, update..." style="background: var(--bg-input); color: var(--text-color); border: 1px solid var(--border);">
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: var(--radius-lg); background: var(--bg-card); color: var(--text-color);">
                <div class="card-body p-4">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-3 text-center {{ $news->image ? '' : 'd-none' }}" id="imagePreviewContainer">
                            <img src="{{ $news->image ? asset('storage/' . $news->image) : '' }}" id="imagePreview" class="img-fluid rounded" style="max-height: 200px; object-fit: cover;">
                        </div>
                    </div>
