...
@section('title', __('Create Auction'))
...
<div class="page-header">
    <div>
        <h1 style="font-weight: 700; color: #0f172a; margin-bottom: 8px;">{{ __('Create Auction') }}</h1>
                ...
                <div class="card-body-premium">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="title_ar" id="title_ar" class="form-control" placeholder="{{ __('Enter auction title in Arabic') }}" value="{{ old('title_ar') }}" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="form-label">{{ __('Title (English)') }}</label>
                            <input type="text" name="title_en" id="title_en" class="form-control" placeholder="{{ __('Enter auction title in English') }}" value="{{ old('title_en') }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group mb-0">
                            ...
                            <input type="text" name="location_ar" id="location_ar" class="form-control" placeholder="مثال: الرياض، المملكة العربية السعودية" value="{{ old('location_ar') }}">
                        </div>
                        <div class="col-md-6 form-group mb-0">
                            <label class="form-label">{{ __('Location (English)') }}</label>
                            <input type="text" name="location_en" id="location_en" class="form-control" placeholder="Example: Riyadh, Saudi Arabia" value="{{ old('location_en') }}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="vehicle_id" class="form-control form-select" required>
                            ...
                            @foreach($vehicles as $vehicle)
                                <option value="{{ $vehicle->id }}" {{ old('vehicle_id') == $vehicle->id ? 'selected' : '' }}>{{ $vehicle->title }} ({{ $vehicle->id }})</option>
                            @endforeach
                        </select>
                    </div>

                    <div class="form-group mb-0">
                        <label class="form-label">{{ __('Auction Main Image') }} <span class="text-muted fw-normal ms-1">({{ __('Optional') }})</span></label>
                ...
                <div class="card-body-premium">
                    <div class="row">
                        <div class="col-md-6 form-group mb-3 mb-md-0">
                            ...
                            <textarea name="description_ar" id="description_ar" class="form-control" rows="5" placeholder="{{ __('Enter auction description in Arabic...') }}">{{ old('description_ar') }}</textarea>
                        </div>
                        <div class="col-md-6 form-group mb-0">
                            <label class="form-label">{{ __('Description (English)') }}</label>
                            <textarea name="description_en" id="description_en" class="form-control" rows="5" placeholder="{{ __('Enter auction description in English...') }}">{{ old('description_en') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body-premium">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control form-select" required style="font-weight: 600;">
                                ...
                                <option value="live" {{ old('status') == 'live' ? 'selected' : '' }}>🟢 {{ __('Live') }}</option>
                            </select>
                        </div>
                ...
                <div class="premium-card mb-4">
                    ...
                    <div class="card-body-premium" style="padding: 20px;">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="number" name="auto_extend_minutes" class="form-control" value="{{ old('auto_extend_minutes', 0) }}" placeholder="0">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body-premium" style="padding: 20px;">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" name="start_price" class="form-control" placeholder="0.00" value="{{ old('start_price') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="reserve_price" class="form-control" placeholder="0.00" value="{{ old('reserve_price') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">{{ __('Min Bid Increment') }}</label>
                            <input type="number" step="0.01" name="min_bid_increment" class="form-control" placeholder="0.00" value="{{ old('min_bid_increment') }}" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">{{ __('Buy Now Price') }} <span class="text-muted fw-normal ms-1">({{ __('Optional') }})</span></label>
                            <input type="number" step="0.01" name="buy_now_price" class="form-control" placeholder="0.00" value="{{ old('buy_now_price') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">{{ __('Commission Rate (%)') }}</label>
                            <input type="number" step="0.01" name="commission_rate" class="form-control" placeholder="0.00" value="{{ old('commission_rate') }}">
                        </div>
                        <div class="form-group mb-0">
                            <label class="form-label">{{ __('Deposit Amount') }}</label>
                            <input type="number" step="0.01" name="deposit_amount" class="form-control" placeholder="0.00" value="{{ old('deposit_amount', 0) }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="premium-card mb-4">
                    <div class="card-body-premium" style="padding: 20px;">
                        <label class="custom-toggle mb-3">
                            ...
                            <div class="switch">
                                <input type="checkbox" name="deposit_required" value="1" {{ old('deposit_required', true) ? 'checked' : '' }}>
