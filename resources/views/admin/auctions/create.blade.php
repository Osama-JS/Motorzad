...
<div class="page-header">
    <div>
        <h1 class="h3 mb-1 font-weight-extrabold">{{ __('Create Auction') }}</h1>
...
<form id="createAuctionForm" action="{{ route('admin.auctions.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card-body-premium">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="title_ar" id="title_ar" class="form-control" placeholder="{{ __('Enter auction title in Arabic') }}" required>
                            <div class="invalid-feedback error-title_ar"></div>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="form-label">{{ __('Title (English)') }}</label>
                            <input type="text" name="title_en" id="title_en" class="form-control" placeholder="{{ __('Enter auction title in English') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-0">
                            ...
                            <input type="text" name="location_ar" id="location_ar" class="form-control" placeholder="مثال: الرياض، المملكة العربية السعودية">
                            <div class="invalid-feedback error-location_ar"></div>
                        </div>
                        <div class="col-md-6 form-group mb-0">
                            <label class="form-label">{{ __('Location (English)') }}</label>
                            <input type="text" name="location_en" id="location_en" class="form-control" placeholder="Example: Riyadh, Saudi Arabia">
                ...
                <div class="card-body-premium">
                    <div class="row">
                        <div class="col-12 form-group mb-4">
                            ...
                            <textarea name="description_ar" id="description_ar" class="form-control summernote"></textarea>
                            <div class="invalid-feedback error-description_ar"></div>
                        </div>
                        <div class="col-12 form-group mb-0">
                            <label class="form-label">{{ __('Description (English)') }}</label>
                            <textarea name="description_en" id="description_en" class="form-control summernote"></textarea>
                ...
                <div class="premium-card mb-4">
                    ...
                    <div class="card-body-premium" style="padding: 20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="buy_now_price" class="form-control" placeholder="0.00">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="number" step="0.01" name="deposit_amount" class="form-control" placeholder="0.00" value="0" required>
                ...
                <div class="premium-card mb-4">
                    <div class="card-body-premium" style="padding: 20px;">
                        <label class="custom-toggle mb-3">
                            ...
                            <div class="switch">
                                <input type="checkbox" name="deposit_required" value="1" checked>
...
<script>
    $(document).ready(function() {
        ...
        $('#createAuctionForm').on('submit', function(e) {
            ...
            btn.find('span').last().text("{{ __('Saving...') }}");
