...
<x-admin-header :title="__('User Management')" :breadcrumb="__('Users')">
   <button type="button" class="btn-ultra" data-bs-toggle="modal" data-bs-target="#addUserModal">
...
<!-- KYC Data Modal -->
<div class="modal fade" id="kycDataModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('بيانات توثيق الحساب') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="kycDataBody">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="confirmKycApprovalBtn">{{ __('تأكيد الموافقة') }}</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    window.UserConfig = {
        ...
        trans: {
            ...
            beneficiaryName: "{{ __('Beneficiary Name') }}",
