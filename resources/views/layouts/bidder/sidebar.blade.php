    <aside class="sidebar bidder-sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('bidder.auctions.my-bids') }}" class="nav-item {{ request()->routeIs('bidder.auctions.my-bids') ? 'active' : '' }}">
            ...
            <div class="nav-section-title">{{ __('معرضي') }}</div>
            <a href="{{ route('bidder.garage.create') }}" class="nav-item {{ request()->routeIs('bidder.garage.create') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                <span>{{ __('إضافة سيارة جديدة') }}</span>
            </a>
            <a href="{{ route('bidder.garage.index') }}" class="nav-item {{ request()->routeIs('bidder.garage.index') ? 'active' : '' }}">
                ...
                <span>{{ __('سياراتي المعروضة') }}</span>
            </a>
            <a href="{{ route('bidder.garage.auctions.index') }}" class="nav-item {{ request()->routeIs('bidder.garage.auctions.index') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
                <span>{{ __('مزاداتي') }}</span>
            </a>
            <a href="{{ route('bidder.garage.drafts') }}" class="nav-item {{ request()->routeIs('bidder.garage.drafts') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                <span>{{ __('مسوداتي') }}</span>
            </a>
            @endif
            ...
            @if(!auth()->user()->hasRole('seller'))
                <a href="{{ route('bidder.become-seller') }}" class="nav-item {{ request()->routeIs('bidder.become-seller') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                    <span>{{ __('الاشتراك كبائع') }}</span>
                </a>
            @endif
            
            <a href="{{ route('bidder.support.index') }}" class="nav-item {{ request()->routeIs('bidder.support.*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                <span>{{ __('الدعم الفني') }}</span>
            </a>
