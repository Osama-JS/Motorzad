...
<div class="premium-actions">
    ...
    <a href="{{ route('bidder.auctions.my-bids') }}" class="p-action-card blue">
        <div class="p-action-icon">
    ...
    <div class="grid-col-right">
        ...
        <div class="premium-wallet">
            ...
            <div class="wallet-buttons">
                <a href="{{ route('bidder.wallet.index') }}" class="w-btn deposit" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center; gap:0.5rem;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                    {{ __('Deposit') }}
                </a>
                <a href="{{ route('bidder.wallet.index') }}" class="w-btn withdraw" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center; gap:0.5rem;">
