        ...
        <div class="bid-panel">
            ...
            <div class="bid-form-group" id="manualBidGroup">
                ...
                <div class="bid-input-wrap">
                    <input type="number" id="bidAmountInput" value="{{ $auctionData['min_bid_increment'] }}" min="{{ $auctionData['min_bid_increment'] }}" step="{{ $auctionData['min_bid_increment'] }}">
                ...
                <div style="display: flex; justify-content: space-between; margin-top: 0.5rem; align-items: center; flex-wrap: wrap; gap: 0.5rem;">
                    ...
                    <div style="font-weight: 800; color: var(--brand-red); font-size: 0.95rem; background: rgba(239, 68, 68, 0.1); padding: 0.25rem 0.75rem; border-radius: 100px;">
                        {{ app()->getLocale() === 'ar' ? 'الإجمالي:' : 'Total:' }} <span id="totalBidPreview">{{ number_format($auctionData['current_price'] + $auctionData['min_bid_increment']) }}</span> SAR
                    </div>
                </div>
            </div>
